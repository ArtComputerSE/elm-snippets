...
module Main exposing (Machine, machine, ourSitesBlob, result2, result3, sites1, sites2, sites3)
...
machine =
    Decode.map2 Machine (Decode.field "ip" Decode.string) (Decode.field "version" Decode.string)
